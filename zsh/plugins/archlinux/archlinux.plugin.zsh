...
if (( $+commands[trizen] )); then
  alias yaconf='trizen -C'
  alias yaupg='trizen -Syyu --no{edit,info}'
  alias yain='trizen -S --no{edit,info}'
  alias yains='trizen -U'
  alias yare='trizen -R'
  alias yarem='trizen -Rns'
  alias yarep='trizen -Si'
  alias yareps='trizen -Ss'
  alias yaloc='trizen -Qi'
  alias yalocs='trizen -Qs'
  alias yalst='trizen -Qe'
  alias yaorph='trizen -Qtd'
  alias yainsd='trizen -S --asdeps'
  alias yamir='trizen -Syy'
  alias yaupd="trizen -Sy"
